...
{
    static_assert(TypeAlignment >= alignof(Type), "Alignment mismatch! No safe instantiation of Type possible!");
    static_assert(TypeSize >= sizeof(Type), "Size mismatch! Not enough space to instantiate Type!");
