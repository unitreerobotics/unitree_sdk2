...
bool unitree_go__msg__res__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_go.msg._res.Res", full_classname_dest, 23) == 0);
  }
  unitree_go__msg__Res * ros_message = _ros_message;
  {  // uuid
...
PyObject * unitree_go__msg__res__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_go.msg._res");
