...
bool unitree_go__msg__time_spec__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_go.msg._time_spec.TimeSpec", full_classname_dest, 34) == 0);
  }
  unitree_go__msg__TimeSpec * ros_message = _ros_message;
  {  // sec
...
{
  /* NOTE(esteve): Call constructor of TimeSpec */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_go.msg._time_spec");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TimeSpec");
