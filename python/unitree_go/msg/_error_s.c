...
bool unitree_go__msg__error__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_go.msg._error.Error", full_classname_dest, 27) == 0);
  }
  unitree_go__msg__Error * ros_message = _ros_message;
  {  // source
    ...
    ros_message->source = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // state
...
PyObject * unitree_go__msg__error__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_go.msg._error");
