...
bool unitree_go__msg__height_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_go.msg._height_map.HeightMap", full_classname_dest, 36) == 0);
  }
  unitree_go__msg__HeightMap * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of HeightMap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_go.msg._height_map");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HeightMap");
  ...
  {  // origin
    ...
    float * src = &(ros_message->origin[0]);
