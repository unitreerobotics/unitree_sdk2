...
bool unitree_go__msg__req__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_go.msg._req.Req", full_classname_dest, 23) == 0);
  }
  unitree_go__msg__Req * ros_message = _ros_message;
  {  // uuid
...
{
  /* NOTE(esteve): Call constructor of Req */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_go.msg._req");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Req");
