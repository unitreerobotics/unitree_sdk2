...
bool unitree_go__msg__path_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_go.msg._path_point.PathPoint", full_classname_dest, 36) == 0);
  }
  unitree_go__msg__PathPoint * ros_message = _ros_message;
  {  // t_from_start
    PyObject * field = PyObject_GetAttrString(_pymsg, "t_from_start");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->t_from_start = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // x
  ...
  {  // vyaw
    ...
    assert(PyFloat_Check(field));
    ros_message->vyaw = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * unitree_go__msg__path_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_go.msg._path_point");
  ...
  {  // t_from_start
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->t_from_start);
    {
      int rc = PyObject_SetAttrString(_pymessage, "t_from_start", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
